...
export const rolePermissionsApi = {
  async create(payload: CreateRolePermissionRequest): Promise<RolePermissionResponse> {
    const { data } = await http.post<RolePermissionResponse>('/role-permissions', payload)
    return data
  },
