 ...
 * `electronicbilling.create` (que el backend otorga únicamente a las empresas con el
 * submódulo BILLING de la membresía). Si no lo tiene, el módulo se oculta por completo.
 *
