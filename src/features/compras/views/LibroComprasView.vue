  ...
  <div class="page">
    <header class="page-head">
      <div class="title-wrap">
        ...
        <div>
          ...
          <p class="sub">Facturas de proveedor del periodo · sede {{ branchStore.selectedBranchId ? 'seleccionada' : '(todas)' }}</p>
        </div>
      </div>
    </header>
    ...
    <div class="table-wrap">
      <table class="grid-table">
        <thead>
          <tr>
            <th>Proveedor</th><th>NIT</th><th>Factura</th><th>Emisión</th>
            <th class="num">Base</th><th class="num">Impuesto</th><th class="num">Retención</th>
            <th class="num">Total</th><th class="num">Pagado</th><th class="num">Saldo</th><th>Estado</th>
          </tr>
        </thead>
        <tbody>
