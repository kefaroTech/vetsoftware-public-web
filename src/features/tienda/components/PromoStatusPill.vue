...
import type { DerivedPromoStatus } from '../types/tienda'
...
<template>
  <span class="pill" :style="{ background: TONE[status].bg, color: TONE[status].fg }">
    <span class="dot" :style="{ background: TONE[status].dot }" />
