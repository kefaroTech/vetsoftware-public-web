...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { guestOnly: true, title: 'Iniciar sesión — Lumbre' },
    },
    {
      path: '/registro',
      name: 'signup',
      component: () => import('@/features/registration/views/SignupView.vue'),
      meta: { guestOnly: true, title: 'Crea tu cuenta — Lumbre' },
    },
    {
      path: '/verify-email',
      name: 'verify-email',
      component: () => import('@/features/registration/views/VerifyEmailView.vue'),
      meta: { guestOnly: true, title: 'Verifica tu correo — Lumbre' },
    },
    {
      ...
      meta: { requiresAuth: true, title: 'Cambiar contraseña — Lumbre' },
    },
    {
      ...
      meta: { title: 'Recuperar contraseña — Lumbre' },
    },
    {
      ...
      meta: { title: 'Recuperar código de usuario — Lumbre' },
    },
    {
      ...
      meta: { title: 'Restablecer contraseña — Lumbre' },
    },
    {
      path: '/dashboard',
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            ...
            hideTopbar: true,
            permission: PERMISSIONS.CONSULTATION_CREATE,
            title: 'Consulta guardada — Lumbre',
          },
        },
        {
          ...
          children: [
            {
              ...
              meta: { title: 'Historia clínica — Lumbre' },
            },
            {
              ...
              props: true,
              meta: { title: 'Mascotas del propietario — Lumbre' },
            },
            {
              ...
              props: true,
              meta: { title: 'Historia clínica de la mascota — Lumbre' },
            },
          ],
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.VACCINATION_CREATE,
            title: 'Registrar vacunación — Lumbre',
          },
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.HOSPITALIZATION_CREATE,
            title: 'Registrar hospitalización — Lumbre',
          },
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.LABORATORY_TEST_CREATE,
            title: 'Exámenes de laboratorio — Lumbre',
          },
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.DIAGNOSTIC_IMAGING_CREATE,
            title: 'Imágenes diagnósticas — Lumbre',
          },
        },
        {
          ...
          meta: { permission: PERMISSIONS.VACCINATION_CREATE, title: 'Vacunaciones — Lumbre' },
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.HOSPITALIZATION_CREATE,
            title: 'Hospitalizaciones — Lumbre',
          },
        },
        {
          ...
          meta: { permission: PERMISSIONS.DEWORMING_CREATE, title: 'Desparasitaciones — Lumbre' },
        },
        {
          path: 'acciones/cirugia',
          name: 'acciones-cirugia',
          component: () => import('@/features/acciones/views/SurgeryListView.vue'),
          meta: { permission: PERMISSIONS.SURGERY_CREATE, title: 'Cirugías — Lumbre' },
        },
        {
          path: 'acciones/spa',
          name: 'acciones-spa',
        ...
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.LABORATORY_TEST_READ,
            title: 'Bandeja de muestras — Lumbre',
          },
        },
        {
          path: 'hospital',
          ...
          meta: {
            permission: PERMISSIONS.HOSPITALIZATION_READ,
            title: 'Pacientes internados — Lumbre',
          },
        },
        {
          path: 'tienda',
        ...
        },
        {
          ...
          meta: {
            title: 'Órdenes de compra y recepciones — Lumbre',
        ...
        },
        {
          ...
          meta: {
            ...
            title: 'Facturas de proveedor — Lumbre',
          },
        },
        {
          path: 'compras/libro',
          ...
          meta: {
            permission: PERMISSIONS.PURCHASE_REPORT_READ,
            title: 'Libro de compras — Lumbre',
          },
        },
        {
          ...
          children: [
            {
              ...
              meta: { title: 'Cuentas abiertas — Lumbre' },
            },
            {
              path: ':accountId',
              ...
              props: true,
              meta: { title: 'Detalle de cuenta — Lumbre' },
            },
          ],
        },
        {
        ...
        },
        {
          ...
          meta: {
            permission: PERMISSIONS.ELECTRONIC_BILLING_CREATE,
            title: 'Habilitación de facturación electrónica — Lumbre',
          },
        },
        {
          path: 'empresa',
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              meta: { permission: PERMISSIONS.ENTITLEMENT_READ, title: 'Cupos y consumo — Lumbre' },
            },
            {
              path: 'cobros',
              ...
              meta: {
                permission: PERMISSIONS.SUBSCRIPTION_BILLING_READ,
                title: 'Cuentas de cobro — Lumbre',
              },
            },
            {
              path: 'cobros/:id',
              ...
              meta: {
                permission: PERMISSIONS.SUBSCRIPTION_BILLING_READ,
                title: 'Detalle de cuenta de cobro — Lumbre',
              },
            },
            {
              path: 'medios-pago',
              ...
              meta: {
                permission: PERMISSIONS.SUBSCRIPTION_PAYMENT_METHOD_READ,
                title: 'Medios de pago — Lumbre',
              },
            },
            {
              path: 'cotizaciones',
              ...
              meta: { permission: PERMISSIONS.QUOTE_READ, title: 'Cotizaciones — Lumbre' },
            },
            {
              ...
              props: true,
              meta: { permission: PERMISSIONS.QUOTE_READ, title: 'Detalle de cotización — Lumbre' },
            },
          ],
        },
        {
          ...
          meta: { permission: PERMISSIONS.EMPLOYEE_READ, title: 'Empleados — Lumbre' },
        },
        {
          path: 'roles',
          name: 'roles',
        ...
        },
        {
          ...
          meta: { permission: PERMISSIONS.PRESCRIPTION_CREATE, title: 'Medicamentos — Lumbre' },
        },
      ],
    },
    {
