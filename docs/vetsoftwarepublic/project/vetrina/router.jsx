...
const VET_ROUTES = [
  { name: 'landing',                      path: '/',                                meta: { guestOnly: true } },
  { name: 'login',                        path: '/login',                           meta: { guestOnly: true } },
  { name: 'signup',                       path: '/registro',                        meta: { guestOnly: true } },
  { name: 'verify-email',                 path: '/verify-email',                    meta: { guestOnly: true } },
  { name: 'cambiar-contrasena',           path: '/cambiar-contrasena',              meta: { requiresAuth: true } },
  { name: 'recuperar-contrasena',         path: '/recuperar-contrasena',            meta: {} },
  { name: 'recuperar-codigo',             path: '/recuperar-codigo',                meta: {} },
  { name: 'restablecer-contrasena',       path: '/restablecer-contrasena',          meta: {} },
  ...
  { name: 'tienda-pos',                   path: '/dashboard/tienda',                meta: { requiresAuth: true } },
  { name: 'tienda-inventario',            path: '/dashboard/tienda/inventario',     meta: { requiresAuth: true } },
  { name: 'tienda-servicios',             path: '/dashboard/tienda/servicios',      meta: { requiresAuth: true } },
  ...
  { name: 'cuentas',                      path: '/dashboard/cuentas',               meta: { requiresAuth: true } },
  { name: 'facturacion-habilitacion',     path: '/dashboard/facturacion/habilitacion', meta: { requiresAuth: true } },
  { name: 'facturacion-documentos',       path: '/dashboard/facturacion/documentos', meta: { requiresAuth: true } },
  { name: 'facturacion-reportes',         path: '/dashboard/facturacion/reportes',  meta: { requiresAuth: true } },
  ...
  { name: 'empresa',                      path: '/dashboard/empresa',               meta: { requiresAuth: true } },
  { name: 'roles',                        path: '/dashboard/roles',                 meta: { requiresAuth: true } },
  { name: 'medicamentos',                 path: '/dashboard/catalogos/medicamentos', meta: { requiresAuth: true } },
];
...
function VetRouterProvider({ children }) {
  ...
  const route = matched
    ...
    : { name: 'landing', params: {}, query: {}, path: '/', meta: {} };
