...
function VetMedicamentosView() {
  return (
    <VetRoutePlaceholder
      title="Catálogo de medicamentos"
      description="Administración del catálogo de medicamentos de la empresa (crear, editar, presentaciones y concentraciones). Consumido por el modal de Receta del wizard de consulta."
      vueFiles={['features/medicamentos/views/MedicamentosView.vue']}
    />
  );
}
