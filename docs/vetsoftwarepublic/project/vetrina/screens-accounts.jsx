  ...
  return (
    <div className="vet-shop-inv">
      <header className="vet-shop-inv-head">
        <div>
          <div className="vet-shop-kicker">Facturación</div>
          <h1 className="vet-shop-title">Cuentas</h1>
          <div className="vet-shop-sub" style={{ fontSize: 13, color: 'var(--warm-500)', marginTop: 4 }}>Cuentas a crédito por propietario. Los cargos se agrupan por mascota.</div>
        </div>
