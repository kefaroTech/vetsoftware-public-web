        ...
        {draft.actionsCount > 0 && (
          <VetSectionCard Icon={VetIcons.Plus} title="Acciones generadas">
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              {draft.state.prescriptions.length > 0 && <VetChip variant="accent">💊 {draft.state.prescriptions.length} plan{draft.state.prescriptions.length === 1 ? '' : 'es'} terapéutico{draft.state.prescriptions.length === 1 ? '' : 's'}</VetChip>}
