...
export const catalogsApi = {
  ...
  diagnosticImagingTypes: {
    list: () => http.get<ImagingType[]>('/api/diagnostic-imaging-types/available'),
    create: (data) => http.post('/api/diagnostic-imaging-types/available', data),
  },
  vaccineTypes: {
  ...
  surgeryTypes: {
    list: () => http.get<SurgeryType[]>('/api/surgery-types/available'),
    create: (data) => http.post('/api/surgery-types/available', data),
  },
};
```
