  ...
  return (
    <div className="vet-lab-page">
      <header className="vet-lab-header">
        <div>
          <div className="vet-lab-kicker">Laboratorio · Procesamiento</div>
          <h1 className="vet-lab-title">Muestras</h1>
          <div className="vet-lab-lead">
            Procesa las muestras recolectadas y consulta el histórico de resultados validados.
          </div>
        </div>
      </header>
