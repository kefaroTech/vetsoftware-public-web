...
const vetHomeStyles = {
  greetingTitle: {
    ...
    fontSize: 44, lineHeight: 1.05, letterSpacing: '-0.015em',
    fontWeight: 400, color: 'var(--warm-900)',
  },
  greetingTitleEm: { fontStyle: 'italic', color: 'var(--amatista-700)' },
  greetingSubtitle: { margin: '8px 0 0', fontSize: 14, color: 'var(--warm-600)' },
  ...
  statLabel: { fontSize: 11.5, color: 'var(--warm-500)', marginBottom: 6 },
  statValue: { fontSize: 26, fontWeight: 500, letterSpacing: '-0.02em', color: 'var(--warm-900)' },

  ctaRow: { display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 16, marginBottom: 28 },
  ctaPrimary: {
    position: 'relative', overflow: 'hidden',
    background: 'linear-gradient(135deg, oklch(45% 0.18 var(--hue)), oklch(38% 0.18 295))',
    color: 'white', borderRadius: 16, padding: '28px 30px',
  ...
  ctaPrimaryTitle: { margin: '8px 0 10px', fontSize: 22, fontWeight: 500, letterSpacing: '-0.01em' },
  ctaPrimaryDesc: { margin: 0, fontSize: 13, opacity: 0.75, lineHeight: 1.5, maxWidth: 380 },
  ctaBtnPrimary: {
    display: 'inline-flex', alignItems: 'center', gap: 6,
